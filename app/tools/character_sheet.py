...
class AbilityScore(BaseModel):
	...
	proficient: Annotated[bool, Field(
...
class CharacterSheet(BaseModel):
	...
	total_character_level: Annotated[int, Field(
		description="The level of the character.",
		ge=1,
		le=30,
		default=1,
	)]
	classes: Annotated[list[CharacterClass], Field(
		description="The character's classes.",
	)]
	strength: Annotated[AbilityScore, Field(
		description="The character's Strength score.",
	)]
	dexterity: Annotated[AbilityScore, Field(
		description="The character's Dexterity score.",
	)]
	constitution: Annotated[AbilityScore, Field(
		description="The character's Constitution score.",
	)]
	intelligence: Annotated[AbilityScore, Field(
		description="The character's Intelligence score.", 
	)]
	wisdom: Annotated[AbilityScore, Field(
		description="The character's Wisdom score.",
	)]
	charisma: Annotated[AbilityScore, Field(
		description="The character's Charisma score.",
	)]
	skill_proficiencies: Annotated[list[str], Field(
		description="List of the character's skill proficiencies.",
		default_factory=list,
	)]
	weapon_proficiencies: Annotated[list[str], Field(
		description="List of the character's weapon proficiencies.",
		default_factory=list,
	)]
	other: Annotated[list[str], Field(
